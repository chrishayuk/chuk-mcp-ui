...
import { calendarSchema } from "./zod";

describe("calendar zod schema validation", () => {
  it("accepts minimal valid calendar", () => {
    ...
    expect(calendarSchema.safeParse(data).success).toBe(true);
  });
  ...
  it("rejects missing type field", () => {
    ...
    expect(calendarSchema.safeParse(data).success).toBe(false);
  });
