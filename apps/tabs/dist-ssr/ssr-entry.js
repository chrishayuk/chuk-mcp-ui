...
const ViewBusContext = reactExports.createContext(null);
function useViewBusContainer() {
  const ctx = reactExports.useContext(ViewBusContext);
  if (!ctx) {
    throw new Error(
...
function TabsInner({ data }) {
  ...
  const [active, setActive] = reactExports.useState(activeTab ?? ((_a = tabs[0]) == null ? void 0 : _a.id) ?? "");
  const currentTab = tabs.find((t) => t.id === active) ?? tabs[0];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full font-sans bg-background", children: [
        ...
        children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: cn(
              ...
              tab.id === active ? "border-primary text-primary font-semibold" : "border-transparent text-muted-foreground font-normal"
            ),
            children: tab.label
          },
          tab.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "tabpanel", className: "flex-1 overflow-hidden", children: currentTab && /* @__PURE__ */ jsxRuntimeExports.jsx(TabPanel, { tab: currentTab }) })
  ] });
}
...
function render(data) {
  return server_nodeExports.renderToString(/* @__PURE__ */ jsxRuntimeExports.jsx(TabsInner, { data }));
}
export {
  render
};
