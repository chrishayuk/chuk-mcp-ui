...
function render(data) {
  return server_nodeExports.renderToString(
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full font-sans bg-background text-foreground", children: [
      data.title && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-[15px] font-semibold border-b", children: data.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-4 text-muted-foreground", children: "Loading PDF…" })
    ] })
  );
}
export {
