...
function VideoRenderer({ data }) {
  ...
  reactExports.useEffect(() => {
    const video = videoRef.current;
    if (!video || data.playing === void 0) return;
    if (data.playing) {
      video.play().catch(() => {
      });
    } else {
  ...
  reactExports.useEffect(() => {
    const video = videoRef.current;
    if (!video || data.currentTime === void 0) return;
    video.currentTime = data.currentTime;
  }, [data.currentTime]);
  reactExports.useEffect(() => {
    const video = videoRef.current;
    if (!video || data.playbackRate === void 0) return;
    video.playbackRate = data.playbackRate;
  }, [data.playbackRate]);
  reactExports.useEffect(() => {
    const video = videoRef.current;
    if (!video || data.volume === void 0) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        data.title && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-[15px] font-semibold border-b", children: data.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-2 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "video",
          {
            ref: videoRef,
            src: data.url,
